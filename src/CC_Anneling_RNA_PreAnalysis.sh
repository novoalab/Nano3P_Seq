##################################################
### PRE-ANALYSIS OF THE CURLCAKE ANNEALING RUN ###
###################################################
...
input=/no_backup_isis/enovoa/data/ont/template_switching/cDNA325423/cDNA325423/cDNA325423/20191107_2138_MN22127_ABC838_95d49f59/fast5
output=/users/enovoa/boguzhan/NanoCapture/cDNA325423_Curlcake_Annealing/
...
minimap2 -ax map-ont --MD $ref cDNA325423.fastq > cDNA325423.bam

samtools view -hSb -F 3844 cDNA325423.bam >  cDNA325423.sam

samtools view -hb -f 0x10 cDNA325423.sam | samtools sort - cDNA325423.sorted && samtools index cDNA325423.sorted.bam
